# SC4x | Week 10 | Case Study | ML 2

## Overview
This app uses an AI API (OpenAI, Gemini, or Claude) to provide feedback on an open response question about machine learning: Which classification algorithm(s) would you use?
